...
/* package KataFizzBuzz-0.1.0.0 */
#ifndef VERSION_KataFizzBuzz
#define VERSION_KataFizzBuzz "0.1.0.0"
#endif /* VERSION_KataFizzBuzz */
#ifndef MIN_VERSION_KataFizzBuzz
#define MIN_VERSION_KataFizzBuzz(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_KataFizzBuzz */
...
#define CURRENT_COMPONENT_ID "KataFizzBuzz-0.1.0.0-inplace-KataFizzBuzz"
